            ...
            <div class="thumbnail">          
              <div class="hienthi">
                ...
                <div class="caption">
                  ...
                  <p>
                    <span class="btn btn-price"><strong>{!!number_format($row->price)!!} Vnđ</strong> </span>
                  </p>
                </div>
              </div>
              <div class="tomtat">
                <div class="thongtin">
                  ...
                  <div class="price">  
                    <span class="btn btn-price btn-block "><strong>{!!number_format($row->price)!!}</strong> Vnđ</span>   
