  ...
  <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                                ...
                                <div class="row">
                                  ...
                                  <img src="{!!url('/uploads/products/details/'.$row->images_url)!!}" alt="ả{!!$data->name!!}" width="50" height="40">
                              </a> @endforeach
                                                </div>
                                        ...
                                        <label class="btn btn-large btn-block btn-price">{!!number_format($data->price)!!} VNĐ</label>
                                    </div>
                                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
                                        ...
                                        @if($data->status ==1)
                                        <a href="{!!url('gio-hang/addcart/'.$data->id)!!}" title="" class="btn btn-large btn-block btn-buy_ins" style="font-size: 20px;">Đặt hàng ngay</a> @else
                                        <a href="" title="" class="btn btn-large btn-block btn-primary disabled" style="font-size: 20px;">Tạm hết hàng</a> @endif
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                                ...
                                <div class="accordion-group">
                                    ...
                                    <button class="SeeMore btn btn-primary" data-toggle="collapse" href="#collapseTwo">Xem chi tiết <b class="caret"></b></button>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <hr>
                            <h2 style="padding-left: 30px;"> Tin tức công nghệ </h2> {{-- @include('modules.tin-tuc') --}}
                        </div>
                        <!-- /row -->
                    </div>
                </div>
    ...
    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        @foreach($lap as $row)
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                        ...
                        <div class="hienthi">
                            ...
                            <div class="caption">
                                ...
                                <p>
                                    ...
                                    {{--
                                    <li><i>{!!$row->cpu!!}</i></li> --}}
                                    <span class="label label-info ">Ưu đãi khi mua</span> @if ($row->promo1!='')
                                ...
                                <p>
                                    <span class="btn btn-price label-warning"><strong>{!!number_format($row->price)!!} Vnd</strong> </span>
                                </p>
                            </div>
                        </div>
                        <div class="tomtat">
                  ...
                  <li><strong>Pin</strong> :<i> {!!$row->pin!!}</i></li>
                            ...
                            <div class="price">
                                <span class="btn btn-price btn-block "><strong>{!!number_format($row->price)!!}</strong> Vnd</span>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body no-padding">
                <a href="#" title=""><img src="{{asset('images/slides/thumbs/qc1.png')}}" alt="" width="100%" height="100%"> </a>
                <br>
                <a href="#" title=""><img src="{{asset('images/slides/thumbs/qc2.png')}}" alt="" width="100%" height="100%"> </a>
                <br>
                <a href="#" title=""><img src="{{asset('images/slides/thumbs/qc3.png')}}" alt="" width="100%" height="100%"> </a>
                <a href="#" title=""><img src="{{asset('images/slides/thumbs/qc4.png')}}" alt="" width="100%" height="100%"> </a>
                <a href="#" title=""><img src="{{asset('images/slides/thumbs/qc5.png')}}" alt="" width="100%" height="100%"> </a>
            </div>
        </div>
        <!-- /panel info 2  quản cáo 1          -->
        <!-- /panel info 2  quản cáo 1          -->
