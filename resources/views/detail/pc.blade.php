    ...
    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="panel panel-default">
          ...
          $mobile = DB::table('products')
                ...
                ->select('products.*','pro_details.cpu','pro_details.ram','pro_details.screen','pro_details.vga','pro_details.storage','pro_details.exten_memmory','pro_details.sim','pro_details.connect','pro_details.pin','pro_details.os','pro_details.note')
        ...
        ?> @foreach($mobile as $row)
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                  ...
                  <li><strong>Pin</strong> :<i> {!!$row->pin!!}</i></li>
                        ...
                        <span class="btn btn-price"><strong>{!!number_format($row->price)!!}</strong>Vnd </span>
