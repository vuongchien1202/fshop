                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                                ...
                                <div class="row">
                                  ...
                                  <img src="{!!url('uploads/products/details/'.$row->images_url)!!}" alt="{!!$data->name!!}" width="30" height="40">
                                        ...
                                        <label class="btn btn-large btn-block btn-warning btn-price">{!!number_format($data->price)!!} VNĐ</label>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <div class="panel panel-default">
                                        ...
                                        <div id="links">
                                            @foreach($data->detail_img as $row)
                                            <a href="{!!url('uploads/products/details/'.$row->images_url)!!}" title="{!!$data->name!!}" data-gallery>
                              <img src="{{asset('uploads/products/details/'.$row->images_url)}}" alt="{!!$data->name!!}"  width="25%" height="120">
                          </a> @endforeach
                                        </div>
                                        <!-- The Bootstrap Image Gallery lightbox, should be a child element of the document body -->
                                        <div id="blueimp-gallery" class="blueimp-gallery">
        ...
        ?> @foreach($mobile as $row)
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                    <div class="thumbnail mobile">
                        <div class="bt">
                            ...
                            <div class="intro pull-right">
                                ...
                                <li>{!!$row->intro!!}</li>
                                <span class="label label-info">Khuyễn mãi</span> @if ($row->promo1!='')
                  ...
                  <li><strong>Pin</strong> :<i> {!!$row->pin!!}</i></li>
                        ...
                        <span class="btn label-warning btn-price"><strong>{!!number_format($row->price)!!}</strong> VNĐ </span>
